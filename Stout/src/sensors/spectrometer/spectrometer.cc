...
//     if (AVS_PrepareMeasure(handle, &meas_config)!=ERR_SUCCESS) {
//       std::cerr << "Could not find spectrometer when attempting to read" << std::endl; //DEBUG
//       return false;
//     }
//     // Signal to start the measurement
//     if (AVS_Measure(handle,0,1)!=ERR_SUCCESS) {
//       std::cerr << "Err in Measure" << std::endl; //
//       return false;
//     }
//
//     // Wait for the measurement to complete
//     while (AVS_PollScan(handle)!=1) {
...
//     if (AVS_GetLambda(handle,d_spectrum)!=ERR_SUCCESS) {
//       std::cerr << "Err in GetScopeData" << std::endl; //
//       return false;
//     }
//
...
//     if (AVS_GetAnalogIn(handle, 0, &voltage)!=ERR_SUCCESS) {
//       return false;
//     }
//
